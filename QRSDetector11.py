...
class QRSDetectorOffline(object):
    def __init__(self, ecg_data_input):
        """
        ...
        self.ecg_data_input = ecg_data_input
        ...
        self.integration_window = 18  # Change proportionally when adjusting frequency (in samples).

        self.findpeaks_limit = 0
        self.findpeaks_spacing = 72  # Change proportionally when adjusting frequency (in samples).

        self.refractory_period = 173  # Change proportionally when adjusting frequency (in samples).
    ...
    def load_ecg_data(self):
        ...
        self.ecg_data_raw = self.ecg_data_input
    ...
    def detect_peaks(self):
        ...
        print(self.detected_peaks_indices)
...
if __name__ == "__main__":
    qrs_detector = QRSDetectorOffline(ecg_data_input="ecg_data/ecg_data_1.csv")
